...
Emacs has some built-in versioning functionality. If you aren’t looking for [[httpsl://semver.org/][Semantic Versioning]] support specifically, that might be for you.
